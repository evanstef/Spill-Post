<nav x-data="{ open: false }" class="sticky top-0 bg-gray-800 border-b border-gray-700 z-30">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            @auth
                <!-- Settings Dropdown -->
                <div class="hidden sm:flex sm:items-center sm:gap-6 sm:ms-6 ease-in-out">
                    {{-- foto dan username dan juga nama --}}
                    <a href="{{ route('profile.show', Auth::user()) }}" class="flex items-center gap-2 duration-300 sm:px-2 xl:px-4 py-1 rounded-lg hover:bg-gray-600 ">
                        <img class="sm:w-6 sm:h-6 md:w-8 md:h-8 rounded-full object-cover" src="{{ Auth::user()->image ? Auth::user()->image : asset('images-profil/gambar-foto-profil-7.jpg') }}" alt="">
                        <div>
